            ...
            return __awaiter(this, void 0, void 0, function () {
                function getDelegation(rewardAddr) {
                    return __awaiter(this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, _blockfrostRequest("/accounts/".concat(rewardAddr))];
                                case 1:
                                    stake = _a.sent();
                ...
                return __generator(this, function (_l) {
                    switch (_l.label) {
                        ...
                        case 4:
                            delegation = _l.sent();
                            return [4 /*yield*/, _blockfrostRequest("/pools/".concat(poolId))];
                        case 5:
                            pool = _l.sent();
                            poolHex = pool.hex;
                            return [4 /*yield*/, getUtxosHex()];
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, _blockfrostRequest("/epochs/".concat(latestBlock.epoch, "/parameters"))]; //
                        case 2:
                            p = _a.sent() //
                            ;
                            if (!p)
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            _a.trys.push([3, 6, , 7]);
                            return [4 /*yield*/, fetch("".concat(networkEndpoint).concat(endpoint), {
                                    headers: {
